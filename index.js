...
// تجاهل أي طلب على فافيكون لتجنب 404
    ...
    if (body.object === 'page') {
        body.entry.forEach(async entry => {
            ...
            if (webhookEvent.message && webhookEvent.message.text) {
                ...
                if (msg.includes("1")) {
                    reply = `لو هتشرفني التمرين الجي ارجو التاكيد\nمواعيد التدريبات من مواليد ٢٠١٣ حتي ٢٠٢٢ الاحد ٨ م والخميس ٧ مساءا\nمواعيد التدريبات من ٩٩ حتي ٢٠١٢ يوم الاحد ٩ مساءا يوم الخميس ٨ مساءا\n\nالعنوان: ملعب تربية رياضية فيصل بشارع فيصل الرئيسي امام فرع ڤودافون\nلوكيشن: https://maps.app.goo.gl/DP5fs7hZsSQzh2bD8\n\nقيمة الاشتراك بعد الخصم 400 ✅\nقيمة طقم التدريبات بعد الخصم 250 ✅\إجمالي قيمة الاشتراك والطقم 650 🔥\nالاشتراك الأساسي 450 شهريا`;
                } else if (msg.includes("2")) {
                    reply = `لو هتشرفني التمرين الجي ارجو التاكيد\نمواعيد التدريبات من مواليد ٢٠١١ حتي ٢٠٢٢ يومي الجمعة الساعة ٨ مساءا والثلاثاء الساعة ٨ مساءا\نمن مواليد ٩٩ حتي ٢٠١٠ يومي الجمعة ٨ مساءا والثلاثاء الساعة ٨ مساءا\n\نالعنوان: ملاعب الليسية الفرنسية امام نادي الجلاء مباشرة ( بجوار محطة مترو هارون )\نلوكيشن: https://maps.app.goo.gl/QeVKAaMvtFCmPCwK9?g_st=com.google.maps.preview.copy\n\نقيمة الاشتراك بعد الخصم 400 ✅\نقيمة طقم التدريبات بعد الخصم 250 ✅\إجمالي قيمة الاشتراك والطقم 650 🔥\نالاشتراك الأساسي 450 شهريا`;
                } else if (msg.includes("3")) {
                    reply = `لو هتشرفني يوم الاثنين القادم\نمواعيد التدريبات من مواليد ٢٠١٣ حتي ٢٠٢١ الساعة ٦.٣٠ مساءا يومي الاثنين والخميس\نومن مواليد ٩٩ حتي ٢٠١٢ الساعة ٨ مساءا يومي الاثنين والخميس\n\نالعنوان: كلية الهندسة بالعباسية بجوار محطة مترو عبده باشا\نلوكيشن: https://maps.app.goo.gl/Z4D3wVnHZ2Sk613Y7?g_st=com.google.maps.preview.copy\n\نقيمة الاشتراك بعد الخصم 400 ✅\نقيمة طقم التدريبات بعد الخصم 250 ✅\إجمالي قيمة الاشتراك والطقم 650 🔥\نالاشتراك الأساسي 450 شهريا`;
