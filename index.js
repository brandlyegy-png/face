        ...
        body.entry.forEach(async entry => {
            ...
            if (webhookEvent.message && webhookEvent.message.text) {
                ...
                if (msg.includes("1")) {
                    ...
                    reply = "مع حضرتك كابتن زين مدير التسويق في ناشئين مصر 🤝\nقطاع ناشئين مصر موجودين فين 🇪🇬\n1️⃣ فرع العباسية ( كلية الهندسة )\n2️⃣ فرع مصر الجديدة ( مدرسة الليسية )\n3️⃣ فرع الجيزة ( فيصل )\n4️⃣ فرع القليوبية ( بنها )\nلو سمحت ابعتلي ساكن فين او اقرب فرع لحضرتك ومواليد كام لارسال كافة التفاصيل 🤝 تشرفت بحضرتك";
                }
